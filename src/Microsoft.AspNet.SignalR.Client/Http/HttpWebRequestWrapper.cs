...
namespace Microsoft.AspNet.SignalR.Client.Http
{
    public class HttpWebRequestWrapper : IRequest
    {
        ...
        private IDictionary<string, Action<HttpWebRequest, string>> _restrictedHeaders = new Dictionary<string, Action<HttpWebRequest, string>>() {
        ...
        public void SetRequestHeaders(IDictionary<string, string> headers)
        {
            if (headers != null)
            {
                ...
                {
                    if (!_restrictedHeaders.Keys.Contains(headerEntry.Key))
                    {
#if (!WINDOWS_PHONE && !SILVERLIGHT)
                    ...
                    else
                    {
                        ...
                        _restrictedHeaders.TryGetValue(headerEntry.Key, out action);
